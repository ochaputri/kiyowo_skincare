...
<body>
	...
	<header>
		<div class="container">
			<h1><a href="dashboard.php">Kiyowo's Skincare</a></h1>
			<ul>
		...
		<div class="container">
			...
			<div class="box">
				<form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <textarea class="input-control" name="deskripsi" id="" placeholder="Deskripsi"> <?php echo $p->product_description ?></textarea> <br>
	...
	<footer>
		<div class="container">
			<small>Copyright &copy; 2021 || Kiyowo's Skincare.</small>
		</div>
	</footer>
    <script>
